 ...
 * @author garth
 */
public class LoopbackSmscConfiguration extends SmscConfiguration {
  ...
  /**
   * reroute-smsc-id Tag the rerouted MO with the given value for smsc-id instead of the canonical
