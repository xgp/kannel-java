...
public class KannelJMSGateway extends KannelGateway {
  ...
  public JMSTransport getJMSTransport() {
    return this.jmsTransport;
  }

  public void setJMSTransport(JMSTransport jmsTransport) {
  ...
  public static void main(String args[]) throws Exception {
    ...
    kjmsGateway.setOutBoundThread(
        new JMSWritingThread(kjmsGateway.kannelBind, kjmsGateway.jmsTransport));
    kjmsGateway.setInBoundThread(
        new JMSReadingThread(kjmsGateway.kannelBind, kjmsGateway.jmsTransport));
    kjmsGateway.start();
  }
}
