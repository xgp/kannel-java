...
public class KannelBinding {
	...
	private static final String prop_heartbeat_rate = "KannelBinding.heartbeating_rate";
	private static final String prop_initialConnectedState = "KannelBinding.initialConnectedState";
	private static final String prop_bearerbox_host = "KannelBinding.bearerbox_host";
	private static final String prop_bearerbox_port = "KannelBinding.bearerbox_port";
	private static final String prop_boxc_id = "KannelBinding.boxc_id";

	private long heartBeatRate = 60 * 1000;
	private boolean connectedAtStart = false;
	private InetAddress bearerBox = null;
	private int port = 0;
	private String boxc_id = null;

	private Thread heartBeaterThread = null;
	private HeartBeating heartBeater = null;
	private KSocket kannelSocket = null;
	 ...
	 *      fails
	 */
	public BasicPacket readNext() throws IOException, PacketParseException {
		...
		//synchronized (this.inBoundStream) {
	 ...
	 */
	public  void writeNext(BasicKannelProtocolMessage bkpMessage) throws IOException {
